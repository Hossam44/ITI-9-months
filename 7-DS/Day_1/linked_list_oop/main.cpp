...
{
    L1.Delete_From_linked_listby_ID(temp.id);
    L1.Add_Node(temp);
}
...
void Show_Data_of_all_employee(){
    ...
    node *i=L1.get_start();                              //for first show after delete
...
void delete_by_id()
{
    ...
    scanf("%d",&id);
    system("cls");
    L1.Delete_From_linked_listby_ID(id);
...
void delete_by_name()
{
    ...
    if(nod!=nullptr)
        L1.Delete_From_linked_listby_ID(nod->n.id);
}
